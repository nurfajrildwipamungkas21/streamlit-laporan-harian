...
# --- 5. PEMBAYARAN ---
    ...
    if IS_MOBILE:
        ...
        tab_ptr = 0  # Pointer dimulai dari 0
        ...
        if is_manager:
            ...
            # PENTING: Geser pointer ke tab berikutnya setelah selesai mengisi tab Approval
            tab_ptr += 1
